...
{
    [DbContext(typeof(AzureADDbContext))]
    [Migration("20240628174602_DbEnhancement")]
    partial class DbEnhancement
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AzureAD.Core.Entities.CreditCard", b =>
                {
            ...
            modelBuilder.Entity("AzureAD.Core.Entities.EmailCopy", b =>
                {
            ...
            modelBuilder.Entity("AzureAD.Core.Entities.Expense", b =>
                {
            ...
            modelBuilder.Entity("AzureAD.Core.Entities.ExpenseCategory", b =>
                {
                    b.Property<int>("ExpenseCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AzureAD.Core.Entities.ExpenseItem", b =>
                {
            ...
            modelBuilder.Entity("AzureAD.Core.Entities.ExpenseType", b =>
                {
                    b.Property<int>("ExpenseTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AzureAD.Core.Entities.Family", b =>
                {
            ...
            modelBuilder.Entity("AzureAD.Core.Entities.FamilyMemberRequest", b =>
                {
            ...
            modelBuilder.Entity("AzureAD.Core.Entities.UserBudget", b =>
                {
            ...
            modelBuilder.Entity("AzureAD.Core.Entities.UserIncome", b =>
                {
            ...
            modelBuilder.Entity("AzureAD.Core.Entities.UserProfile", b =>
                {
                    b.Property<int>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AzureAD.Core.Entities.CreditCard", b =>
                {
                    b.HasOne("AzureAD.Core.Entities.UserProfile", "User")
            ...
            modelBuilder.Entity("AzureAD.Core.Entities.Expense", b =>
                {
                    b.HasOne("AzureAD.Core.Entities.CreditCard", "CreditCard")
                        .WithMany("Expenses")
                        .HasForeignKey("CreditCardId")
                        .HasConstraintName("FK_Expense_CreditCard");

                    b.HasOne("AzureAD.Core.Entities.ExpenseCategory", "ExpenseCategory")
                        .WithMany("Expenses")
                        .HasForeignKey("ExpenseCategoryId")
                        .HasConstraintName("FK_Expense_Category");

                    b.HasOne("AzureAD.Core.Entities.ExpenseType", "ExpenseType")
                        .WithMany("Expenses")
            ...
            modelBuilder.Entity("AzureAD.Core.Entities.ExpenseItem", b =>
                {
                    ...
                    b.HasOne("AzureAD.Core.Entities.Expense", "Expense")
                        .WithMany("ExpenseItems")
            ...
            modelBuilder.Entity("AzureAD.Core.Entities.FamilyMemberRequest", b =>
                {
                    b.HasOne("AzureAD.Core.Entities.UserProfile", "RequestedUser")
            ...
            modelBuilder.Entity("AzureAD.Core.Entities.UserProfile", b =>
                {
                    b.HasOne("AzureAD.Core.Entities.Family", "Family")
