...
namespace AzureAD.Web.Controllers
{
    ...
    public class CreditCardController : ControllerBase
    {
        ...
        {
            //added for azure ad demo.

            var creditCards = new List<CreditCardModel>() { new CreditCardModel() { CardLastFourDigit="2332", CreditCardId=2,
             CreditCardName="ICICI", UserId=4} };

            //await _creditCardService.GetCreditCardsByUserIdAsync(userId);
